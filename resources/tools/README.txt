...
Once you have installed Ballerina, you can open a terminal and run the `ballerina` command to use Ballerina. Try running
`ballerina version` to verify that everything is in order. You should see an output similar to the following:
    $ ballerina version
    jBallerina 1.1.0
    Language specification 2019R3
    Ballerina tool 0.8.0

Run `ballerina help` for more information on the commands and the options available.
