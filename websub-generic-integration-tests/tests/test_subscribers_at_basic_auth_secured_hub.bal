...
//
//listener websub:Listener authwebsubEP = new websub:Listener(23485);
...
//    target: "http://localhost:23084/publisher/discover",
//    leaseSeconds: 3600,
...
//    path: "/websubTwo",
//    subscribeOnStartUp: true,
//    target: "http://localhost:23084/publisherTwo/discover",
//    leaseSeconds: 1200,
//    hubClientConfig: {
...
//    }
//}
//service websubSubscriberTwo on authwebsubEP {
//    resource function onNotification (websub:Notification notification) returns @tainted error? {
//        json payload = check notification.getJsonPayload();
...
//@websub:SubscriberServiceConfig {
//    path: "/websubFour",
//    target: "http://localhost:23084/publisherThree/discover",
//    leaseSeconds: 1200,
//    hubClientConfig: {
...
//    http:Client clientEndpoint = new ("http://localhost:23084");
...
//    dependsOn: ["testMultipleSubscribersStartUpInSamePort"]
//}
//function testContentReceiptWithAuth() {
//    http:Client clientEndpoint = new ("http://localhost:23084");
