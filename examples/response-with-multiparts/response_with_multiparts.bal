...
service multipartResponseEncoder on new http:Listener(9092) {
    ...
    resource function multipartSender(http:Caller caller,
        ...
        // [Sets the child parts to the parent part](https://ballerina.io/learn/api-docs/ballerina/mime/objects/Entity.html#setBodyParts).
...
service multipartResponseDecoder on multipartEP {
    ...
    resource function multipartReceiver(http:Caller caller,
        ...
        if (returnResult is http:Response) {
            // [Extracts the body parts from the response](https://ballerina.io/learn/api-docs/ballerina/http/objects/Response.html#getBodyParts).
...
function handleContent(mime:Entity bodyPart) {
    ...
    if (mime:APPLICATION_XML == baseType || mime:TEXT_XML == baseType) {
        // [Extracts `xml` data]((https://ballerina.io/learn/api-docs/ballerina/mime/objects/Entity.html#getXml) from the body part.
        ...
        // [Extracts `json` data](https://ballerina.io/learn/api-docs/ballerina/mime/objects/Entity.html#getJson) from the body part.
        ...
        // [Extracts text data](https://ballerina.io/learn/api-docs/ballerina/mime/objects/Entity.html#getText) from the body part.
        ...
        // [Extracts byte channel](https://ballerina.io/learn/api-docs/ballerina/http/objects/Response.html#getByteChannel) from the body part and save it as a file.
