...
public function main() {
    ...
    if (response is http:Response) {
        // [Get the content type](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response#getContentType) from the response.
...
function handleResponse(http:Response|http:PayloadType|error response) {
    if (response is http:Response) {
        // [Get the JSON payload](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response#getJsonPayload) from the response.
