...
// This is the remote [WebSub Hub client]((https://docs.central.ballerina.io/ballerina/websubhub/latest/websubhub/clients/PublisherClient) to which registration and publish requests are sent.
websubhub:PublisherClient websubHubClientEP =
                    new ("http://localhost:9191/websub/publish");

public function main() {

    // Registers a topic at the hub using [registerTopic](https://docs.central.ballerina.io/ballerina/websub/latest/websub/clients/PublisherClient#registerTopic).
    ...
    // Publishes updates to the remote hub using [publishUpdate](https://docs.central.ballerina.io/ballerina/websub/latest/websub/clients/PublisherClient#publishUpdate).
