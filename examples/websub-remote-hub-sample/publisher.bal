...
// This is the remote [WebSub Hub client]((https://ballerina.io/learn/api-docs/ballerina/#/ballerina/websubhub/latest/websubhub/clients/PublisherClient) to which registration and publish requests are sent.
websubhub:PublisherClient websubHubClientEP =
                    new ("http://localhost:9191/websub/publish");

public function main() {

    // Registers a topic at the hub using [registerTopic](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/websub/latest/websub/clients/PublisherClient#registerTopic).
    ...
    // Publishes updates to the remote hub using [publishUpdate](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/websub/latest/websub/clients/PublisherClient#publishUpdate).
