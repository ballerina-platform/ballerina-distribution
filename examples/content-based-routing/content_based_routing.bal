    ...
    resource function post route(http:Caller outboundEP, http:Request req) {
        ...
        if (jsonMsg is json) {
            ...
            if (nameString is json) {
                ...
                // Use the remote function [respond](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/Caller#respond) to send the client response
                // back to the caller.
