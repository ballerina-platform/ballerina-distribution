...
// The [`task:TimerConfiguration`](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/task/latest/task/records/TimerConfiguration) record to configure the task listener.
