...
function hash() returns error? {
    ...
    // Hashing input value using [MD5 hashing algorithm](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/crypto/functions#hashMd5), and printing hash value using Hex encoding.
