...
public function main() {
    ...
    // The [absFloat](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/functions#absFloat) function returns
    ...
    // The [absInt](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/functions#absInt) function returns
    // the absolute value of an `int` value.
    int absoluteIntValue = math:absInt(-152);
    io:println("Absolute value of -152: ", absoluteIntValue);

    // The [acos](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/functions#acos) function
    // returns the arc cosine of a value.
    float acosValue = math:acos(0.027415567780803774);
    io:println("Arc cosine of 0.027415567780803774: ", acosValue);

    // The [asin](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/functions#asin) function
    // returns the arc sine of a value.
    float arcSineValue = math:asin(0.027415567780803774);
    io:println("Arc sine of 0.027415567780803774: ", arcSineValue);

    // The [atan](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/functions#atan) function
    // returns the arc tangent of a value.
    float arcTangent = math:atan(0.027415567780803774);
    io:println("Arc tangent of 0.027415567780803774: ", arcTangent);

    // The [cbrt](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/functions#cbrt) function
    // returns the cube root of a `float` value.
    float cubeRoot = math:cbrt(-27.0);
    io:println("Cube root of -27.0: ", cubeRoot);

    // There are over 40 [functions](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/math/#functions) in the
