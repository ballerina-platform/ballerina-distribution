...
Using the generated client API, you can retrieve the record by key from the datastore. The `get by key` resource method returns a record or error if no records found for the given key.
