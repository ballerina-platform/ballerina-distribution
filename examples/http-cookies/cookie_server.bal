...
service cookieServer on serverEP {
        ...
        if (details is json) {
            ...
            if (name is json && password is json) {
                ...
                if (password == "p@ssw0rd") {
                    ...
                    // [Create a new cookie](https://ballerina.io/learn/api-docs/ballerina/http/objects/Cookie.html) by setting `name` as the `username`
                    ...
                    // [Add the created cookie to the response](https://ballerina.io/learn/api-docs/ballerina/http/objects/Response.html#addCookie).
    ...
    resource function welcome(http:Caller caller, http:Request req) {
        // [Retrieve cookies from the request](https://ballerina.io/learn/api-docs/ballerina/http/objects/Request.html#getCookies).
