...
public function main() {
    ...
    // Publishes directly to the internal Ballerina hub using [publishUpdate](https://ballerina.io/learn/api-docs/ballerina/websub/objects/Hub.html#publishUpdate).
