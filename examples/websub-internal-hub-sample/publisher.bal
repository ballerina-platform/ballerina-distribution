...
public function main() {
    ...
    // Publishes directly to the internal Ballerina hub using [publishUpdate](https://ballerina.io/swan-lake/learn/api-docs/ballerina/websub/classes/Hub.html#publishUpdate).
