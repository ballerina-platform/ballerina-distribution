...
public function main() {
    ...
    // Publishes directly to the internal Ballerina hub using [publishUpdate](https://docs.central.ballerina.io/ballerina/websub/latest/websub/classes/Hub#publishUpdate).
