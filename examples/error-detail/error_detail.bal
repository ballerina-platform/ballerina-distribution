...
// The `HttpDetail` type is a record type that defines the field `httpCode` of type `int`.
...
// The lang library function `error:detail()` facilitates in extracting the detail value
// out of the error.
