...
// Create an [HTTP client](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/Client) that can send HTTP/2 messages.
...
public function main() {
    ...
    // [Submit a request](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/Client#submit).
    ...
    int promiseCount = 0;
    // [Check if promises exists](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/Client#hasPromise).
    boolean hasPromise = clientEP->hasPromise(httpFuture);

    while (hasPromise) {
        http:PushPromise pushPromise = new;
        // [Get the next promise](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/Client#getNextPromise).
    ...
    // [Get the requested resource](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/Client#getResponse).
