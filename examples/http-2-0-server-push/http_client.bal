...
// Create an [HTTP client](https://ballerina.io/learn/api-docs/ballerina/http/clients/Client.html) that can send HTTP/2 messages.
...
public function main() {
    ...
    // [Submit a request](https://ballerina.io/learn/api-docs/ballerina/http/clients/Client.html#submit).
    ...
    int promiseCount = 0;
    // [Check if promises exists](https://ballerina.io/learn/api-docs/ballerina/http/clients/Client.html#hasPromise).
    boolean hasPromise = clientEP->hasPromise(httpFuture);

    while (hasPromise) {
        http:PushPromise pushPromise = new;
        // [Get the next promise](https://ballerina.io/learn/api-docs/ballerina/http/clients/Client.html#getNextPromise).
        ...
        if (pushPromise.path == "/resource2") {
            ...
            // Therefore, [reject the promise](https://ballerina.io/learn/api-docs/ballerina/http/clients/Client.html#rejectPromise).
    ...
    // [Get the requested resource](https://ballerina.io/learn/api-docs/ballerina/http/clients/Client.html#getResponse).
