// The Ballerina main program, which demonstrates the usage of the [Hub client](https://ballerina.io/learn/api-docs/ballerina/websub/clients/SubscriptionClient.html) to subscribe/unsubscribe to notifications.
import ballerina/io;
