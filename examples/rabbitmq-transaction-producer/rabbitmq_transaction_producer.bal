...
public function main() {
    ...
    rabbitmq:Client newClient = new ({host: "localhost", port: 5672});

    // Declares the queue.
    var queueResult = newClient->queueDeclare("MyQueue");
    ...
    transaction {
        ...
        var sendResult = newClient->basicPublish(
                                        "Hello from Ballerina".toBytes(),
                                        "MyQueue");
