...
// Since compression behaviour of the service is set as [COMPRESSION_AUTO](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#COMPRESSION_AUTO),
// entity body compression is done according to the scheme indicated in `Accept-Encoding` request header. Compression
// is not performed when the header is not present or the header value is "identity".
...
// behaviour ("AUTO", "ALWAYS", "NEVER") for content negotiation.
// Depending on the compression option values, the `Accept-Encoding` header is sent along with the request.
// In this example, the client compression behaviour is set as [COMPRESSION_ALWAYS](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#COMPRESSION_ALWAYS). If you have not specified
...
// If the behaviour is set as [COMPRESSION_NEVER](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#COMPRESSION_NEVER), the client makes sure not to send the `Accept-Encoding` header.
...
// The compression behaviour of the service is inferred by [COMPRESSION_AUTO](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#COMPRESSION_AUTO), which is the default value
