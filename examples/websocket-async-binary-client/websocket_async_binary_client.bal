...
public function main() returns websocket:Error? {
    ...
    websocket:AsyncClient wsClientEp = check new ("ws://echo.websocket.org",
                                          new ClientService());
    // Writes a text message to the server using [writeBinaryMessage](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/ballerina/websocket/latest/websocket/clients/AsyncClient#writeString).
