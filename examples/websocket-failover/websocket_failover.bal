...
service failoverProxyService on new http:Listener(9090) {
    ...
    resource function onOpen(http:WebSocketCaller caller) {
        ...
        // Defines the [webSocket failover client](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/WebSocketFailoverClient).
        ...
        // Once the client is ready to receive frames, the remote [ready](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/WebSocketFailoverClient#ready) function
