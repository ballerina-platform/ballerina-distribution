...
service failoverProxyService on new http:Listener(9090) {
    ...
    resource function onOpen(http:WebSocketCaller caller) {
        ...
        // Defines the [webSocket failover client](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/clients/WebSocketFailoverClient.html).
        ...
        // Once the client is ready to receive frames, the remote [ready](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/clients/WebSocketFailoverClient.html#ready) function
