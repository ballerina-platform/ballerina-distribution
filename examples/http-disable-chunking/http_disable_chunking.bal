...
// The HTTP client's chunking behaviour can be configured as [CHUNKING_AUTO](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#CHUNKING_AUTO),
// [CHUNKING_ALWAYS](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#CHUNKING_ALWAYS),
// or [CHUNKING_NEVER](https://ballerina.io/learn/api-docs/ballerina/http/constants.html#CHUNKING_NEVER).
...
// [http1Settings](https://ballerina.io/learn/api-docs/ballerina/http/records/ClientHttp1Settings.html) annotation
