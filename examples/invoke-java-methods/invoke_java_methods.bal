...
public function main() {
    ...
    // The [fromString](https://docs.central.ballerina.io/ballerina/java/latest/java/functions#fromString) function in 
    ...
    // The [toString](https://docs.central.ballerina.io/ballerina/java/latest/java/functions#toString) function in 
