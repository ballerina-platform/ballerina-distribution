...
public function main() {
    ...
    // The [fromString](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/ballerina/java/latest/java/functions#fromString) function in 
    ...
    // The [toString](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/ballerina/java/latest/java/functions#toString) function in 
