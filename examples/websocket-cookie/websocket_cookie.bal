...
// The HTTP client configurations associated with [enabling cookies](https://docs.central.ballerina.io/ballerina/http/latest/http/records/CookieConfig).
...
public function main() {
    ...
    if (loginResp is http:Response) {
        ...
        if (loginMessage is error) {
            ...
            // [Gets cookies from the `http:Response`](https://docs.central.ballerina.io/ballerina/http/latest/http/classes/Response#getCookies)
