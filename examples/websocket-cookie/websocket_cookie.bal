...
// The HTTP client configurations associated with [enabling cookies](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/records/CookieConfig).
...
public function main() {
    ...
    if (loginResp is http:Response) {
        ...
        if (loginMessage is error) {
            ...
            // [Gets cookies from the `http:Response`](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response#getCookies)
