        ...
        if (details is json) {
            ...
            if (name is json && password is json) {
                ...
                if (password == "p@ssw0rd") {
                    ...
                    // [Create a new cookie](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Cookie) by setting the `name` as the `username`
                    ...
                    // [Add the created cookie to the response](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response#addCookie).
