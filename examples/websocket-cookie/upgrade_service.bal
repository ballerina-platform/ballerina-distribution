...
service cookieServer on new http:Listener(9095) {
        ...
        if (details is json) {
            ...
            if (name is json && password is json) {
                ...
                if (password == "p@ssw0rd") {
                    ...
                    // [Create a new cookie](https://docs.central.ballerina.io/ballerina/http/latest/http/classes/Cookie) by setting the `name` as the `username`
                    ...
                    // [Add the created cookie to the response](https://docs.central.ballerina.io/ballerina/http/latest/http/classes/Response#addCookie).
    ...
    resource function upgrader(http:Caller caller, http:Request req) {
        ...
        // [Retrieve cookies from the request](https://docs.central.ballerina.io/ballerina/http/latest/http/classes/Request#getCookies).
