...
3. In the Microsoft Azure Dashboard [Azure Cosmos DB account](https://portal.azure.com/#create/Microsoft.DocumentDB).
4. Select **Azure Cosmos DB for Table**, enter an account name and resource group name, and click **Review + Create**.

6. Cosmos DB Core
7. Once the database is created, go to the **Data Explorer**, and select **Create Container**.
8. Enter `db1` as the Database ID, `c1` as the collection ID, and click **Ok**.
