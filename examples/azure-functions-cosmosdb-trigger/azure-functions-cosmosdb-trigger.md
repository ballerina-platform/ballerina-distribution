...
3. Create an [Azure Cosmos DB account](https://portal.azure.com/#create/Microsoft.DocumentDB) by selecting **Azure Cosmos DB for Table**, and entering an account name and resource group name.
