...
service SimpleProxyService on new http:Listener(9090) {
    ...
    resource function onOpen(http:WebSocketCaller caller) {
        ...
        // Once the client is ready to receive frames, the remote function [ready](https://ballerina.io/swan-lake/learn/api-docs/ballerina/#/ballerina/http/latest/http/clients/WebSocketClient#ready)
