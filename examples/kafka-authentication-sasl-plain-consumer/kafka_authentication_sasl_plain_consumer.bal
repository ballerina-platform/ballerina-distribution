...
kafka:ConsumerConfiguration consumerConfigs = {
    ...
    auth: {
        ...
        // For information on how to secure values instead of directly using plain text values, see [Defining Configurable Variables](https://ballerina.io/learn/by-example/configurable-variables.html).
        username: "alice",
        password: "alice@123"
    },
