...
// The [Request filter](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/classes/RequestFilter.html) implementation.
// It intercepts the request and adds a new header to the request before it is dispatched to the HTTP resource.
public class RequestFilter {
    *http:RequestFilter;
    // [Intercepts the request](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/classes/RequestFilter.html#filterRequest).
...
// The [response filter](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/classes/ResponseFilter.html) implementation.
// It intercepts the response in the response path and adds a new header to the response.
public class ResponseFilter {
    *http:ResponseFilter;
    // [Intercepts the response](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/classes/ResponseFilter.html#filterResponse).
...
// Creates a new [ResponseFilter](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/classes/ResponseFilter.html).
