...
// The [Request](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Request) implementation.
// It intercepts the request and adds a new header to the request before it is dispatched to the HTTP resource.
public class RequestFilter {
    *http:RequestFilter;
    // [Intercepts the request](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Request#filterRequest).
...
// The [response(https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response) implementation.
// It intercepts the response in the response path and adds a new header to the response.
public class ResponseFilter {
    *http:ResponseFilter;
    // [Intercepts the response](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response#filterResponse).
...
// Creates a new [Response](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/classes/Response).
ResponseFilter responseFilter = new;

// Creates an HTTP listener and assigns the [filters as a config parameter](https://ballerina.io/learn/api-docs/ballerina/#/ballerina/http/latest/http/records/ListenerConfiguration).
