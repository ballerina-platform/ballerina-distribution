...
The generated client API provides support to select relation fields of the entity when retrieving the records/record from the `get` resource function from the data store.
