...
// [followRedirects](https://ballerina.io/learn/api-docs/ballerina/http/records/FollowRedirects.html) record provides configurations associated with HTTP redirects.
