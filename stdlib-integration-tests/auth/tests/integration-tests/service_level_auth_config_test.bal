...
http:Client clientEP5 = new("https://localhost:20005", {
    secureSocket: {
       trustStore: {
...
@test:Config {}
public function testAuthSuccessWithServiceLevelConfigs() {
...
// Authn and authz success test case
@test:Config {}
public function testAuthzFailureWithServiceLevelConfigs() {
    http:Request req = new;
...
@test:Config {}
public function testAuthFailureWithServiceLevelConfigs() {
    http:Request req = new;
