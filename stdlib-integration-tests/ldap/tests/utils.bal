...
const string KEYSTORE_PATH = "src/ldap/tests/resources/keystore/ballerinaKeystore.p12";
const string TRUSTSTORE_PATH = "src/ldap/tests/resources/keystore/ballerinaTruststore.p12";
